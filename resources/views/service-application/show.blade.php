          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-9">
                ...
                <p class="my-2"><i class="fas fa-map-marker-alt"></i> Location: {{$post->ville}}</p>

            </div>
            </div>
            <div class="mb-3 d-flex justify-content-end">
              <div class="my-2">
                <a href="{{route('post.show',['service'=>$post])}}" class="secondary-link"><i class="fas fa-briefcase"></i> View job</a>
              </div>
            </div>
            <div class="mb-3 d-flex justify-content-end">
              <div class="small">
                <a href="{{route('CarServiceApplication.index')}}" class="btn primary-outline-btn">Go back</a>
              </div>
            </div>
          </div>
        </div>
